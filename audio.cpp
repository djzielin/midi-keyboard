...
void send_audio_to_card_jack(float *data, int nframes,bool is_stereo)
{
   jack_default_audio_sample_t *out = (jack_default_audio_sample_t *) jack_port_get_buffer (output_port, nframes);

   memcpy(out,data,nframes*sizeof(float)); //TODO: make work for stereo 
}
...
static snd_pcm_uframes_t period_size=64; //was doing 128
...
void send_audio_to_card_alsa(float *data, int nframes, bool is_stereo)
{
